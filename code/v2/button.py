...
def get_resource_path(relative_path):
    ...
    try:
        ...
        base_path = os.path.dirname(os.path.dirname(script_dir))  # go to repo root
    
    return os.path.normpath(os.path.join(base_path, relative_path))

# Corrected sound path
click_sound = py.mixer.Sound(
    get_resource_path("assets/sounds/click-sound.wav")
)
